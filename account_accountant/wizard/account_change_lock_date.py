...
class AccountChangeLockDate(models.TransientModel):
    ...
    period_lock_date = fields.Date(
        ...
        default=lambda self: self.env.company_id.period_lock_date,
    ...
    fiscalyear_lock_date = fields.Date(
        ...
        default=lambda self: self.env.company_id.fiscalyear_lock_date,
    ...
    tax_lock_date = fields.Date(
        "Tax Lock Date",
        default=lambda self: self.env.company_id.tax_lock_date,
        help='No users can edit journal entries related to a tax prior and inclusive of this date.')


    @api.multi
    def change_lock_date(self):
        self.env.company_id.write({'period_lock_date': self.period_lock_date,
