...
class TestAccountReports(SavepointCase):
    ...
    def setUpClass(cls):
        ...
        chart_template.with_context(allowed_company_ids=cls.company_parent.ids).try_loading_for_current_company()
        ...
        chart_template.with_context(allowed_company_ids=cls.company_child_eur.ids).try_loading_for_current_company()
    ...
    def test_aged_payable_order_by_column(self):
        ...
        self.assertLinesValues(
            ...
            [
                ('partner_a',           '',        '',          0.00,          45.00,         230.00,           0.00,           0.00,            0.00,        275.00),
                ('02/01/2017',      'BILL',  '111100',            '',             '',         230.00,             '',             '',              '',            ''),
                ('03/01/2017',      'BILL',  '111100',            '',          45.00,             '',             '',             '',              '',            ''),
                ('partner_b',           '',        '',          0.00,         345.00,           0.00,           0.00,         180.00,            0.00,        525.00),
                ('12/01/2016',      'BILL',  '111100',            '',             '',             '',             '',         180.00,              '',            ''),
                ('03/01/2017',      'BILL',  '111100',            '',         345.00,             '',             '',             '',              '',            ''),
                ('partner_c',           '',        '',          0.00,           0.00,           0.00,          65.00,        1380.00,            0.00,       1445.00),
                ('12/01/2016',      'BILL',  '111100',            '',             '',             '',             '',        1380.00,              '',            ''),
                ('01/01/2017',      'BILL',  '111100',            '',             '',             '',          65.00,             '',              '',            ''),
                ('partner_d',           '',        '',           0.00,           0.00,          30.00,           0.00,        1380.00,            0.00,       1410.00),
                ('12/01/2016',      'BILL',  '111100',           '',             '',             '',             '',        1380.00,              '',            ''),
                ('02/01/2017',      'BILL',  '111100',            '',             '',          30.00,             '',             '',              '',            ''),
                ('Total',               '',        '',          0.00,         390.00,         260.00,          65.00,        2940.00,            0.00,       3655.00),
