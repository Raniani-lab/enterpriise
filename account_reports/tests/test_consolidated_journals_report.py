...
class TestConsolidatedJournalsReport(TestAccountReportsCommon):
    ...
    def test_consolidated_journals_unfold_1_whole_report(self):
        ...
        self.assertLinesValues(
            ...
            [   0,                                      1,              2,              3],
            [
                ('journal sale (0)',                    2100.0,         2100.0,         ''),
                ('0_1 account_0_1',                     1050.0,         '',             1050.0),
                ('0_2 account_0_1',                     1050.0,         '',             1050.0),
                ('400000 Product Sales',                '',             2100.0,         -2100.0),
                ('journal purchase (1)',                2100.0,         2100.0,         ''),
                ('journal cash (2)',                    2100.0,         2100.0,         ''),
                ('journal bank (3)',                    2100.0,         2100.0,         ''),
                ('journal general (4)',                 2100.0,         2100.0,         ''),
                ('Total',                               10500.0,        10500.0,        ''),
                ('',                                    '',             '',             ''),
                ('Details per month',                   '',             '',             ''),
                ('Jan 2016',                            500.0,          500.0,          ''),
                ('Feb 2016',                            1000.0,         1000.0,         ''),
                ('Mar 2016',                            1500.0,         1500.0,         ''),
                ('Apr 2016',                            2000.0,         2000.0,         ''),
                ('May 2016',                            2500.0,         2500.0,         ''),
                ('Jun 2016',                            3000.0,         3000.0,         ''),
            ],
        )
    ...
    def test_consolidated_journals_filter_journal(self):
        ...
        self.assertLinesValues(
            ...
            [
                ...
                ('',                                    '',             '',             ''),
                ('Details per month',                   '',             '',             ''),
                ('Jan 2016',                            100.0,          100.0,          ''),
                ('Feb 2016',                            200.0,          200.0,          ''),
                ('Mar 2016',                            300.0,          300.0,          ''),
                ('Apr 2016',                            400.0,          400.0,          ''),
                ('May 2016',                            500.0,          500.0,          ''),
                ('Jun 2016',                            600.0,          600.0,          ''),
            ],
        )
