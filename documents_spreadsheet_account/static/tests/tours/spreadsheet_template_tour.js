odoo.define('documents_spreadsheet_account.spreadsheet_template_features', function (require) {
    'use strict';

    require('web.dom_ready');
    const tour = require('web_tour.tour');

    const TEMPLATE_NAME = "Template with special characters";

    tour.register('spreadsheet_template_features', {
        test: true,
        url: '/web',
    }, [
        {
