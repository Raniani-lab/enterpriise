...
var HrReferralDashboardController = KanbanController.extend({
    start: function () {
        this.$('.o_content').addClass('o_referral_kanban_background');
        this.$('.o_content').append("<div class='hr_referral_bg_city'/>");
        this.$('.o_content').append("<div class='hr_referral_bg_grass'/>");
