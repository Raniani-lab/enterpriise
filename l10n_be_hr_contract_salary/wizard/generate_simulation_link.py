...
class GenerateSimulationLink(models.TransientModel):
    ...
    car_id = fields.Many2one('fleet.vehicle', string='Company Car', domain="[('vehicle_type', '=', 'car')]", help="Default employee's company car. If left empty, the default value will be the employee's current car.")
