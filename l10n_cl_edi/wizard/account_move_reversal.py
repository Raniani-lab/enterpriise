...
class AccountMoveReversal(models.TransientModel):
    ...
    l10n_cl_edi_reference_doc_code = fields.Selection([
        ('1', '1. Corrects Referenced Document Text'),
        ('2', '2. Corrects Referenced Document Amount')
    ...
    @api.onchange('l10n_cl_is_text_correction')
    def _set_l10n_cl_edi_reference_doc_code(self):
        for record in self:
            record.l10n_cl_edi_reference_doc_code = '1' if record.l10n_cl_is_text_correction else '2'
