...
class FuenteReportCustomHandler(models.AbstractModel):
    ...
    def _dynamic_lines_generator(self, report, options, all_column_groups_expression_totals):
        ...
        return super()._get_partner_values(report, options, query_results, '_expand_unfoldable_line_fuente')
    ...
    def _expand_unfoldable_line_fuente(self, line_dict_id, groupby, options, progress, offset, unfold_all_batch_data=None):
