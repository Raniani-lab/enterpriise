...
const L10nDePosGlobalState = (PosGlobalState) =>
    class L10nDePosGlobalState extends PosGlobalState {
        // @Override
        constructor() {
            super(...arguments);
            this.token = "";
            ...
            if (this.isCountryGermanyAndFiskaly()) {
                await this.env.services
                    ...
                    .then((data) => {
                        ...
                        this.useKassensichvVersion2 =
                            this.config.l10n_de_fiskaly_tss_id.includes("|");
                        this.apiUrl =
        ...
        async _flush_orders(orders, options) {
            ...
            for (const orderJson of orders) {
                orderObjectMap[orderJson["id"]] = Order.create(
                    {},
                ...
                if (Object.keys(ordersToUpdate).length) {
                    ...
                    const ordersToSave =
                        result && result.length
                            ? fiskalyFailure
                            : fiskalyFailure.concat(sentToFiskaly);
...
const L10nDeOrder = (Order) =>
    class L10nDeOrder extends Order {
        // @Override
        constructor() {
            super(...arguments);
