...
patch(PaymentScreen.prototype, "l10n_mx_edi_pos.PaymentScreen", {
    ...
    async toggleIsToInvoice() {
        ...
        if (this.pos.globalState.company.country.code === 'MX' && !this.currentOrder.is_to_invoice()) {
    ...
    areMxFieldsVisible() {
        return this.pos.globalState.company.country.code === 'MX' && this.currentOrder.is_to_invoice();
    },
});
