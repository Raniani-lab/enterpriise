...
class TestL10nMXTrialBalanceMonth13(TestAccountReportsCommon):
    ...
    def test_non_month_13(self):
        ...
        self.assertLinesValues(
            ...
            [   0,                                                            1,       2,       3,       4,        5,         6],
            [
                ('105.01.01 Domestic customers',                              1000.0,  '',      300.0,   '',       1300.0,    ''),
                ('305.01.01 Profit for the year',                             '',      800.0,   '',      '',       '',        800.0),
                ('401.01.01 Sales and/or services taxed at the general rate', '',      '',      '',      300.0,    '',        300.0),
        ...
        self.assertLinesValues(
            ...
            [   0,                                                            1,         2,         3,       4,        5,         6],
            [
                ('105.01.01 Domestic customers',                              1000.0,    '',        320.0,   '',       1320.0,    ''),
                ('305.01.01 Profit for the year',                             '',        800.0,     '',      250.0,    '',        1050.0),
                ('401.01.01 Sales and/or services taxed at the general rate', '',        '',        250.0,   320.0,    '',        70.0),
                ('999999 Undistributed Profits/Losses',                       '',        200.0,     '',      '',       '',        200.0),
    ...
    def test_month_13(self):
        ...
        self.assertLinesValues(
            ...
            [   0,                                                            1,         2,         3,       4,        5,         6],
            [
                ('105.01.01 Domestic customers',                              1300.0,    '',        '',      '',       1300.0,    ''),
                ('305.01.01 Profit for the year',                             '',        800.0,     '',      250.0,    '',        1050.0),
                ('401.01.01 Sales and/or services taxed at the general rate', '',        300.0,     250.0,   '',       '',        50.0),
                ('999999 Undistributed Profits/Losses',                       '',        200.0,     '',      '',       '',        200.0),
    ...
    def test_comparison(self):
        ...
        self.assertLinesValues(
            ...
            [   0,                                                            1,         2,         3,       4,      5,     6,     7,       8],
            [
                ('105.01.01 Domestic customers',                              1000.0,    '',        300.0,   '',     20.0,  '',    1320.0,  ''),
                ('305.01.01 Profit for the year',                             '',        800.0,     '',      250.0,  '',    '',    '',      1050.0),
                ('401.01.01 Sales and/or services taxed at the general rate', '',        '',        250.0,   300.0,  '',    20.0,  '',      70.0),
                ('999999 Undistributed Profits/Losses',                       '',        200.0,     '',      '',     '',    '',    '',      200.0),
