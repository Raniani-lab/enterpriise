...
""",
    ...
    'assets': {
        'web.assets_backend': [
            'mail_enterprise/static/src/bugfix/bugfix.js',
            ...
            'mail_enterprise/static/src/bugfix/bugfix.scss',
        ...
        'web.qunit_suite_tests': [
            'mail_enterprise/static/src/bugfix/bugfix_tests.js',
        ...
        'web.assets_qweb': [
            'mail_enterprise/static/src/bugfix/bugfix.xml',
