...

{
    ...
    'assets': {
        'web.assets_backend': [
            ...
            'planning/static/src/js/employee_many2many_tags_email.js',
            'planning/static/src/js/planning_send_form_model.js',
            'planning/static/src/js/planning_send_form_view.js',
