...
class account_analytic_line(models.Model):
    ...
    def import_ui_data(self, ls_aals, ls_tasks, ls_projects, context=None):
        ...
        for ls_aal in ls_aals:
            ...
            sv_project = str(ls_aal.get('project_id')) in sv_projects or self.env["ir.model.data"]._xmlid_to_object(str(ls_aal['project_id']))  # Fallback condition: when the project created after the sql select and thus is not in the list.
