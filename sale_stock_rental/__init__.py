...
def _ensure_rental_stock_moves_consistency(cr, registry):
    ...
    with api.Environment.manage():
        ...
        query = """
            ...
            WHERE qty_picked_up > qty_delivered AND is_rental
        """
        ...
        for line in lines_to_move:
            line._move_qty(line.qty_picked_up - line.qty_delivered, line.order_id.warehouse_id.lot_stock_id, line.company_id.rental_loc_id)
