...
class AccountInvoiceLine(models.Model):
    ...
    @api.depends("price_subtotal_signed", "subscription_start_date", "subscription_end_date")
    def _compute_mrr(self):
        ...
        for line in self:
            ...
            line.subscription_mrr = (line.price_subtotal_signed / months) if months else 0
