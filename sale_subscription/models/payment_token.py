...
class PaymentToken(models.Model):
    ...
    def _get_available_tokens(
        self, providers_ids, partner_id=None, logged_in=False, is_subscription=False, **kwargs
    ):
        ...
        :rtype: payment.token
        """
        if not logged_in or not is_subscription:
            return super()._get_available_tokens(
                providers_ids, partner_id=partner_id, logged_in=logged_in, **kwargs
            )
