...
STAT_TYPES = {
    ...
    'net_revenue': {
        ...
        'type': 'sum',
        'add_symbol': 'currency',
        'compute': compute_net_revenue_batch
    },
    'nrr': {
    ...
    'logo_churn': {
        ...
        'type': 'last',
        'add_symbol': '%',
        'compute': compute_logo_churn_batch
    },
    'revenue_churn': {
        ...
        'type': 'last',
        'add_symbol': '%',
        'compute': compute_revenue_churn_batch
    },
    'nb_contracts': {
        ...
        'type': 'last',
        'add_symbol': '',
        'compute': compute_nb_contracts_batch
    },
}
