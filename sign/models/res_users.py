...
class ResUsers(models.Model):
    ...
    sign_initials = fields.Binary(string="Digital Initials", groups="base.group_system")
    sign_signature_frame = fields.Binary(string="Digital Signature Frame", groups="base.group_system")
    sign_initials_frame = fields.Binary(string="Digital Initials Frame", groups="base.group_system")
