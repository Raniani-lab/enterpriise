...
export class SpreadsheetListModel extends EventBus {
     ...
     * @param {import("@spreadsheet/data_sources/metadata_repository").MetadataRepository} services.metadataRepository
     */
        ...
        switch (field.type) {
            ...
            case "many2many": {
                const labels = record[fieldName]
                    .map((id) => this.metadataRepository.getRecordDisplayName(field.relation, id))
