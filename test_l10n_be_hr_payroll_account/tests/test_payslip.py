...
class TestPayslip(common.TransactionCase):
    ...
    def test_payslip(self):
        ...
        self.assertEqual(payslip.get_salary_line_total('ATN.MOB'), 4.00)
        self.assertEqual(payslip.get_salary_line_total('SALARY'), 2659.00)
        self.assertEqual(payslip.get_salary_line_total('ONSS'), -347.53)
        self.assertEqual(payslip.get_salary_line_total('ATN.CAR'), 154.71)
        self.assertEqual(payslip.get_salary_line_total('GROSS'), 2466.18)
        ...
        self.assertEqual(payslip.get_salary_line_total('ATN.MOB.2'), -4.00)
        ...
        self.assertEqual(payslip.get_salary_line_total('NET'), 1873.14)
