...
class TestUi(tests.HttpCase):
    ...
    def test_payslip(self):
        ...
        self.assertEqual(payslip.get_salary_line_total('ATN.CAR'), 149.29)
        self.assertEqual(payslip.get_salary_line_total('GROSS'), 2467.71)
        self.assertEqual(payslip.get_salary_line_total('P.P'), -533.87)
        self.assertEqual(payslip.get_salary_line_total('ATN.CAR.2'), -149.29)
