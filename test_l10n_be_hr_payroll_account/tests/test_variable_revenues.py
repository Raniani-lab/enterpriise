...
class TestVariableRevenues(AccountTestInvoicingCommon):
    ...
    def setUpClass(cls, chart_template_ref='l10n_be.l10nbe_chart_template'):
        ...
        cls.commission_payslip = cls.env['hr.payslip'].create([{
            ...
            'company_id': cls.env.company.id,
            'vehicle_id': cls.car.id,
            'struct_id': cls.env.ref('l10n_be_hr_payroll.hr_payroll_structure_cp200_structure_commission').id,
        ...
        cls.inputs = cls.env['hr.payslip.input'].create([{
            ...
            'sequence': 10,
            'input_type_id': cls.env.ref('l10n_be_hr_payroll.cp200_other_input_commission').id,
            'amount': 8484.0
        }])
    ...
    def test_variable_revenues(self):
        ...
        self.assertAlmostEqual(self.commission_payslip._get_salary_line_total('P.P'), -4310.88, places=2)
        ...
        self.assertAlmostEqual(self.commission_payslip._get_salary_line_total('P.P.ADJ'), 610.82, places=2)
        ...
        self.assertAlmostEqual(self.classic_payslip._get_salary_line_total('P.P'), -233.52, places=2)
        ...
        self.assertAlmostEqual(self.classic_payslip._get_salary_line_total('NET'), 2179.31, places=2)
