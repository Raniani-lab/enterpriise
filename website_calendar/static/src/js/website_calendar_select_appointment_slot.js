odoo.define('website_calendar.select_appointment_slot', function (require) {
'use strict';
...
publicWidget.registry.websiteCalendarSlotSelect = publicWidget.Widget.extend({
    selector: '.o_website_calendar_appointment',
    xmlDependencies: ['/website_calendar/static/src/xml/calendar_appointment_slots.xml'],
    events: {
    ...
    _onCalendarNavigate: function (ev) {
        var parent = this.$('.o_wcalendar_month:not(.d-none)');
    ...
    _onClickDaySlot: function (ev) {
        ...
        $(qweb.render('website_calendar.slots_list', {
