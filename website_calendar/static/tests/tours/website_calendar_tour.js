odoo.define('website_calendar.website_calendar_tour', function(require) {
"use strict";

var tour = require('web_tour.tour');

tour.register('website_calendar_tour', {
    test: true,
    url: '/web',
}, [
    tour.stepUtils.showAppsMenuItem(),
    {
        ...
        trigger: 'a[data-menu-xmlid="website_calendar.appointment_type_menu"]',
