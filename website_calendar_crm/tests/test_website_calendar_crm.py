...
class WebsiteCalendarCRMTest(TestCrmCommon):
    @classmethod
    ...
    @classmethod
    def setUpClass(cls):
        super(WebsiteCalendarCRMTest, cls).setUpClass()
        ...
        cls.categ_id = cls.env.ref('website_calendar.calendar_event_type_data_online_appointment')
    ...
    def test_create_opportunity(self):
        ...
        self.assertTrue(self.env.ref('website_calendar_crm.appointment_crm_tag') in lead.tag_ids)
    ...
    def test_tag_deleted(self):
        ...
        """
        self.env.ref('website_calendar_crm.appointment_crm_tag').unlink()
        event = self.env['calendar.event'].create(self._prepare_event_value(
            self.appointment_type_create,
            self.user_sales_leads,
            self.contact_1,
